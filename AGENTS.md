...
войны. Спецификация — `PRD_Casandra_Index.md` (v1.3). Стек: чистый HTML/CSS/ES-модули,
ноль зависимостей и сборки; графика — инлайн-SVG из данных; Node ≥ 18.

## Команды

- Тесты: `node --test` (без аргументов) — 80 passed / 0 fail, подтверждено оркестратором.
...
`node --test` без аргументов (14 файлов, 80 тестов). Один файл: `node --test tests/<имя>.test.js`.
