window.STATE =
{
  ...
  "tickets": [
    ...
    { "id": "08", "title": "Лексика, hero, бейдж качества, модалка", "requirements": ["R05","R06","R08","R10","R12","R14","R53","R59","R60","R61"], "blockedBy": ["03","05"], "wave": 3, "zone": ["js/sections/hero.js","js/sections/states.js","index.html"], "status": "done", "startedAt": "2026-09-24T22:14:30+03:00", "finishedAt": "2026-09-24T23:00:00+03:00", "commit": "3b7caad", "retries": 0, "repairs": 0, "handoffs": 0 },
  ...
  "concerns": [
    ...
    "08 craft · js/i18n.js:186 RU method.not.1 · строка грамматически недостроена после вырезки запрещённого слова (EN-зеркало завершённое) — переписать завершённо (concerns)",
    "08 craft · tests/lexicon.test.js:14 · /вероятн/i без границ слова ловит «невероятно/маловероятно» — добавить lookaround по \\p{L} (concerns)"
  ],
